module DuctExtension
  module Catalog
    ...
    module MasterFlow
      ...
      # ---- ELBOWS -------------------------------------------------------------
      # Round elbows are stocked adjustable products and are modeled here in a
      # fixed 90-degree installed configuration. The nominal diameter/SKU matrix
      # is catalog-authoritative. The loaded assembled envelope heights are used
      # to derive the 90-degree centerline radius so the modeled fitting does not
      # silently fall back to the generic Simple Duct bend radius.
      ROUND_ELBOWS = [
        ["B90E3",  3.0,  7.0],
        ["B90E4",  4.0,  7.5],
        ["B90E5",  5.0,  9.0],
